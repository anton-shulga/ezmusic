                ...
                <div class="col s8 offset-s2">
                    <div class="card z-depth-4">
                        <div class="card-content">
                            <span class="card-title"><h3>${requestScope.author.name}</h3></span>
                            <div class="row">
                                <div class="center">
                                    <img src="${pageContext.request.contextPath}/${requestScope.author.photoPath}" alt="author" class="circle responsive-img center">
                                </div>
                            </div>
