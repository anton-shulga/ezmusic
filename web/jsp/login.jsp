                    ...
                    <div class="card z-depth-5">
                        <div class="card-content">
                            ...
                            <form method="POST" action="${pageContext.request.contextPath}/controller">
                                ...
                                <div class="row">
                                    <div class="input-field col s12 required">
                                        <i class="material-icons prefix">lock</i><input id="id-user-password"
                                                                                        name="user_password"
                                ...
                                <div class="row">
                                    <button id="id-sing-in-button" class="col s12 waves-effect waves-light btn black"
                                            type="submit"><fmt:message key="button.sign_in"/></button>
                                </div>
                            </form>
                            ...
                            <div class="row">
                                <form action="${pageContext.request.contextPath}/controller" method="POST">
                                    ...
                                    <button class="col s12 waves-effect waves-light btn black" type="submit">
                                        <fmt:message key="button.sign_up"/></button>
                                </form>
                            </div>
                        </div>
                    </div>
