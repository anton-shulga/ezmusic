                        ...
                        <form method="POST" action="${pageContext.request.contextPath}/controller">
                            ...
                            <div class="row">
                                <div class="input-field col s12 required">
                                    ...
                                    <input id="id-user-login" name="user_login" type="text" required minlength="3" title="<fmt:message key="validation.username"/>"/>
                            ...
                            <div class="row">
                                <div class="input-field col s12 required">
                                        ...
                                        <input id="id-user-password" name="user_password" type="password" required minlength="3">
                                        <label for="id-user-password" class=""><fmt:message key="label.password"/></label>

                                    <div class="right">
                                        <input id="id-show-password" type="checkbox" onchange="document.getElementById('id-user-password').type = this.checked ? 'text' : 'password'"/>
                            ...
                            <div class="row">
                                <div class="input-field col s12">
                                    ...
                                    <label for="id-user-first-name" class=""><fmt:message key="label.first_name"/></label>
                                </div>
                            </div>
                            <div class="row">
                                <div class="input-field col s12">
                            ...
                            <div class="row">
                                <div class="input-field col s12">
                                    ...
                                    <input id="id-user-phone" name="user_phone" type="text" required pattern="[+]{0,1}[0-9]{12}" title="+375251112223">
                                    <label for="id-user-phone"><fmt:message key="label.phone"/> </label>
                                </div>
                            </div>
                            <div class="card-action">
                                <div class="row">
                                    <button id="id-submit" class="col s12 waves-effect waves-light btn black" type="submit"><fmt:message key="button.sign_up"/></button>
                                </div>
                            </div>
                        </form>
                    </div>
