...
/**
 * Created by Антон on 25.09.2016.
 */
public class MessageKey {
    public static final String OOPS = "message.oops";
    public static final String INPUT = "message.input";
    ...
    public static final String NO_MONEY = "message.no_money";
    public static final String REGISTERED = "message.registered";
